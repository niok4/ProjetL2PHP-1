...
--
-- Hôte : localhost
-- Généré le :  mer. 26 mai 2021 à 11:25
...
(1, 1, '2021-06-09', '11:08:00'),
(2, 1, '2021-06-11', '11:08:00'),
(3, 1, '2021-06-11', '11:08:00'),
(4, 1, '2021-06-11', '11:08:00'),
(5, 1, '2021-06-17', '11:08:00'),
(6, 1, '2021-06-17', '11:08:00'),
(7, 1, '2021-06-18', '11:08:00');
...
(1, 'International', '2021-05-28', 30, 2, 'Paris', 8);
...
ALTER TABLE `EquipePoule`
  ADD PRIMARY KEY (`idEquipe`,`idPoule`),
...
ALTER TABLE `Preinscription`
  ADD PRIMARY KEY (`idEquipe`,`idTournoi`),
  ADD KEY `FK_Preinscription_Tournoi` (`idTournoi`);
...
--
ALTER TABLE `Preinscription`
  ADD CONSTRAINT `FK_Preinscription_Equipe` FOREIGN KEY (`idEquipe`) REFERENCES `Equipe` (`idEquipe`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_Preinscription_Tournoi` FOREIGN KEY (`idTournoi`) REFERENCES `Tournoi` (`idTournoi`) ON DELETE CASCADE ON UPDATE CASCADE;
